...
export const emailService = {
  ...
  /**
   * Enviar codigo de reset de senha
   */
  ...
  /**
   * Enviar boas vindas apos registro
   */
  ...
  /**
   * Aviso de falha na renovacao da assinatura
   */
  ...
  /**
   * Aviso de assinatura prestes a expirar
   */
